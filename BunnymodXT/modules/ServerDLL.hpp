...
class ServerDLL : public IHookableDirFilter
{
	...
	HOOK_DECL(Vector, __cdecl, CBaseEntity__FireBullets3_Linux, void* thisptr, Vector vecSrc, Vector vecDirShooting, float vecSpread, float flDistance, int iPenetration, int iBulletType, int iDamage,float flRangeModifier, entvars_t* pevAttacker, bool bPistol, int shared_rand)
